    ...
    <Container maxWidth="sm" style={{ marginTop: '200px' }}>
      ...
      >
        <Typography component="h1" variant="h6">
          How many credit hours do you want to take per semester?
        </Typography>
        <br />
        <FormControl fullWidth>
          <InputLabel shrink={inputValue !== ''} id="demo-simple-select-label">
            # of Hours
          </InputLabel>
          <TextField
            id="outlined-number"
        ...
        <Stack spacing={2} direction="row">
          <Button variant="text" onClick={handleGenerateSchedules}>
            Generate
          </Button>
        </Stack>
      </Box>
